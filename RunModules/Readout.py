...
def compute_test_scores(pred_class, Yte):
    ...
    pred_class: This is an array that contains the predicted class labels for the test data.

    Yte: This is a 2D array that represents the true class labels for the test data.
         Each row in Yte is a one-hot encoded vector where the true class is marked as 1, and all other classes are marked as 0.
    """
